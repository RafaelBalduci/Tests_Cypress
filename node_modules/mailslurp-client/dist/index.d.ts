 ...
 *
 * ```javascript
 * // call convenience functions on the main instance
 * const email = await mailslurp.waitForLatestEmail(...args)
 *
 * // call controllers to access full API methods matching REST API
...
export declare class MailSlurp {
    ...
    readonly sentEmailsController: SentEmailsControllerApi;
    /**
